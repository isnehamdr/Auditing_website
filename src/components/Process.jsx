...
const StepCard = ({ number, title, description }) => (
  ...
  <div className="flex flex-row gap-4 sm:flex-col sm:gap-0">
    <div className="flex-shrink-0 w-10 h-10 rounded-full shadow-lg border border-blue-200 flex items-center justify-center text-[#38b6ff] font-bold text-lg sm:mb-4 bg-white">
      {number}
    </div>
    <div>
      <h3 className="text-base sm:text-lg md:text-2xl font-normal text-[#1a1a2e] mb-2">
        {title}
      </h3>
    ...
    <section className="max-w-7xl mx-auto py-12 sm:py-20 px-4 sm:px-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-12 items-start mb-6 sm:mb-8">
        <div>
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-normal text-[#1a1a2e]">
            How It Works
          </h2>
        </div>
        <p className="text-base sm:text-lg text-gray-700 pt-0 md:pt-2">
      ...
      <div className="relative mb-6 sm:mb-10">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-0.5 bg-[#38b6ff]" />
      </div>
