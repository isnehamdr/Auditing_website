    ...
    >
      ...
      <div className="flex flex-col md:hidden">
        ...
        >
          ...
          <div>
            <Link to="/contact" className="bg-white text-gray-800 hover:bg-[#38b6ff] hover:border hover:border-white hover:text-white font-medium text-lg sm:px-8 sm:py-4 px-6 py-3 rounded-full transition-colors duration-200">
      ...
      <div className="hidden md:flex relative z-10 max-w-7xl mx-auto w-full min-h-screen flex-row">
        <div className="relative z-10 flex flex-col justify-center md:w-1/2 px-8 md:px-12 md:py-12 overflow-hidden">
          ...
          >
            <Link to="/contact" className="bg-white text-gray-800 hover:bg-[#38b6ff] hover:border hover:border-white hover:text-white font-medium text-lg px-8 py-4 rounded-full transition-colors duration-200">
              Request a Consultation
            </Link>
          </div>
        </div>
